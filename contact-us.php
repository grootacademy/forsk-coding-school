                    ...
                    <div class=" col-lg-6 col-md-12 lg-pl-0 md-mb-30">
                        <div class="contact-info contact-address">
                            ...
                            <div class="content-part">
                                <h5 class="info-subtitle">Address Pratap nagar Branch</h5>
                            ...
                            <div class="content-part">
                                <h5 class="info-subtitle">Address Mansarovar Branch</h5>
                                <h6 class="info-title">122/66, First Floor AGARWAL FARM, JAIPUR, Rajasthan 302020 </h6>
                            </div>
                        </div>
                    </div>
